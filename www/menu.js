function menu(cp = "", cp1 = "", cp2 = "", cp3 = "") {
    ...
    cx.child(
        el('span').text('Menu').color('#FFFFFF').size('20px').margin('0 15px').click(async function () {
            menu();
        })
    );
    cx.child(
    ...
    async function loadList(el) {
        ...
        globalThis.updateFunc = async function (id) {
        ...
        globalThis.deleteFunc = async function (id) {
        ...
        if (cp != "" || cp1 != "" || cp2 != "" || cp3 != "") {
            ...
            data = await axios.post(globalThis.hostApi + 'get/' + cp + "/" + cp1 + "/" + cp2 + "/", params);
        } else {
            data = await axios.post(globalThis.hostApi + 'get');
        }
                ...
                .child(
                    ...
                    <table style="padding: 20px 0; width: 100%;">
                        ...
                        <tr>
                            <td colspan="3">
                            <center>
                            <button style="width: 40%; padding: 12px 10px; border-radius: 20px; outline: none; font-size: 14px; background-color: white; border: 1px solid rgb(0, 28, 82); margin: 18px 0px 18px 0.5%;" onclick="globalThis.updateFunc(${data[xx].id})" >Lunas</button>
                            <button style="width: 40%; padding: 12px 10px; border-radius: 20px; outline: none; font-size: 14px; background-color: white; border: 1px solid rgb(0, 28, 82); margin: 18px 0px 18px 0.5%;" onclick="globalThis.editData(${data[xx].id})" >Edit</button>
                            </center>
                            </td>
                        </tr>
                        <tr>
                            <td colspan="3">
                            <center>
                            <button style="margin-top: -10px; width: 80%; padding: 12px 10px; border-radius: 20px; outline: none; font-size: 14px; background-color: #f10a22; color: white; border: 1px solid rgb(0, 28, 82); margin: 18px 0px 18px 0.5%;" class="button-bayar" onclick="globalThis.deleteFunc(${data[xx].id})" >Hapus Fintech</button>
                            </center>
                            </td>
                        </tr>
                    </table>
